...
<script>
	...
	*********************************************************************************************/ 
	...
	function init(){
		if( "null"  == "<%=(String) session.getAttribute("m_id")%>"  || "" == "<%=(String) session.getAttribute("m_id")%>" || "<%=(String) session.getAttribute("m_grade")%>
	" == 0) {
			$("#btn_modify").hide();
			$("#btn_delete").hide();
		}
	...
	function fn_Bind(response) {
		...
		if (origin_file_name1 !== null && origin_file_name1 !== undefined
				&& origin_file_name1 !== "") {
			origin_file_name1 = "<a href='/upload/"+file_path+"/"+target_file_name1+"' download='"+origin_file_name1+"' target='_self'>"
					+ origin_file_name1 + "</a>";
		...
		if (origin_file_name2 !== null && origin_file_name2 !== undefined
				&& origin_file_name2 !== "") {
			origin_file_name2 = "<a href='/upload/"+file_path+"/"+target_file_name2+"' download='"+origin_file_name2+"' target='_self'>"
					+ origin_file_name2 + "</a>";
				...
				<div class="baord">
					<div class="view">
						<div class="col01">
							...
							<p class="sm_txt">
								<span class="notice_nm"></span>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<span
									class="notice_regdtm">2023.05.13</span>
							</p>
							<p>
								조회수: <span class="view_cnt"></span>
							</p>
							<p class="txt_area notice_contents"></p>
							<p class="tac">
								<button class="btn_like">
									<img class="btn_likeIcon" src="../../img/btn_like.png"
										alt="like"> <span class="btn_likeNum notice_likeNum"></span>
								</button>
							</p>
						</div>
						<div class="col02">
							<label class="attach_area"><span id="origin_file_name1">첨부파일이
									없습니다.</span></label> <label class="attach_area"><span
								id="origin_file_name2"></span></label>
						</div>
					</div>
					<div class="navigation clear">
						<a href="javascript:///" class="fl nv_prev">이전</a> <a
							href="../notice/notice.do">LIST</a> <a href="javascript:///"
